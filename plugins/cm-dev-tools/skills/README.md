...
| Audit documentation consistency across repos | [cm-docs-sync](cm-docs-sync/SKILL.md) |
...
- **cm-parity-check** — TUI ↔ Web parity verification (permanent rule)
- **cm-pr-comments** — PR comment triage, fix, and thread resolution
